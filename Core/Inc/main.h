...
#define GPIO_EXTI11_nFAULT_GPIO_Port GPIOB
#define GPIO_EXTI11_nFAULT_EXTI_IRQn EXTI15_10_IRQn
#define GPIO_Output_LED_Pin GPIO_PIN_6
#define GPIO_Output_LED_GPIO_Port GPIOC
#define SPI1_CS_PIN_Pin GPIO_PIN_15
